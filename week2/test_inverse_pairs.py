...
from week2.inverse_pairs import Solution
...
class TestSolution(TestCase):
    def test_inverse_pairs(self):
        ...
        s = Solution()
        self.assertEqual(s.InversePairs(nums), 7)
        nums1 = [364, 637, 341, 406, 747, 995, 234, 971, 571, 219, 993, 407, 416, 366, 315, 301, 601, 650, 418, 355,
        ...
        self.assertEqual(s.InversePairs(nums1), 2519)
